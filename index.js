...
"productImageCount": 1,
'url': `wa.me/6283830930643`
},
"businessOwnerJid": "6283830930643@s.whatsapp.net",
"contextInfo": {
"forwardingScore": 3,
"isForwarded": true
}
...
if (database === true) {if (!isRegistered) return sendButtonNotRegis(from)}  
if (isBanned) return replysticker(banstc) 
sendButtonImageLoc(from, `Mau jadi bot beli jasa run bot ketik aja owner lalu chat, bisa set bot semaumu`, support, buttonsmenu2, { quoted: mek,contextInfo:{mentionedJid: [player, numbernye, ow, dev]}} ) 
break
case 'mystatus':             
case 'status':
case 'mystat':
